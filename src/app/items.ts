import { Response } from '../app/interfaces/item.interface';

export const ItemsData: Response = {
  result: '',
  data: [
    {
      id: '1',
    ...
    },
    {
      ...
      brandName: 'Nike',
      mainImage:
        'https://s3-eu-west-1.amazonaws.com/api.themeshplatform.com/media/f97b0cb2546e4a53af4739505f093089_1.jpg',
      price: {
        amount: '75.00',
        currency: 'GBP',
      },
      ...
      colour: 'yellow',
      description:
        'In 1998, fashion and sport collided in the Nike Air Max Plus.Tuned Air® unit in the heel makes for extra comfort and cushioning with every step.Synthetic mesh upper includes patent leather accents for a comfortable, supportive fit.Rubber outsole delivers excellent traction.',
    },
  ],
};
